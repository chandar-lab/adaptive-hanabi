  ...
  do
    ...
    do
      ...
      do
        ...
        echo "#SBATCH -o ${SCRATCH}/scratch/hanabi_exps/logs/slurm-%j.out" >> temprun.sh
        ...
        echo "python ${SCRATCH}/adaptive-hanabi/pyhanabi/selfplay.py \
             --save_dir ${SCRATCH}/hanabi_exps/${method}-sad1-op${shuffle_color}-lstmlayers${num_lstm_layer}-seed${seed} \
             --num_thread 80 \
